...
from unitree_lerobot.eval_robot.image_server.multi_image_client import MultiImageClient
...
def setup_image_client(args: argparse.Namespace) -> dict[str, Any]:
    ...
    elif not WRIST and getattr(args, "sim", False):
        img_client = MultiImageClient(
            tv_img_shape=tv_img_shape,
            tv_img_shm_name=tv_img_shm.name,
            server_address="127.0.0.1",
